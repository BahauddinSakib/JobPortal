...
function mainSliderTwo() {
	...
	BasicSlider.slick({
		...
		fade: true,
		arrows: true,
		prevArrow: '<button type="button" className="slick-prev"><i className="fa-solid fa-arrow-left"></i></button>',
		nextArrow: '<button type="button" className="slick-next"><i className="fa-solid fa-arrow-right"></i></button>',
...
/*=============================================
	=    		 Cart Active  	         =
=============================================*/
$(".cart-plus-minus").append('<div className="dec qtybutton">-</div><div className="inc qtybutton">+</div>');
...
$('[data-countdown]').each(function () {
	...
	$this.countdown(finalDate, function (event) {
		$this.html(event.strftime('<div className="time-count day"><span>%D</span><strong>Days</strong> </div><div className="time-count hour"><span>%H</span><strong>hrs</strong></div><div className="time-count min"><span>%M</span><strong>min</strong></div><div className="time-count sec"><span>%S</span><strong>sec</strong></div>'));
	});
});
